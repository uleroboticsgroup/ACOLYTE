...
It also contains the AcolyteConfig class, which inherits from the SingletonMeta class and is
responsible for configuration. It reads the configuration file and retrieves and stores the
property values.
"""
...
ACOLYTE_CONF_FILE = 'ACOLYTE_CONF_FILE'
...
class AcolyteConfig(metaclass=SingletonMeta):
    """
    ...
    def __read_configuration_file(self):
        self.__conf_file = os.environ.get(
            ACOLYTE_CONF_FILE, "topics-config.yaml")
